...
export class PlayerDisplayData {
    ...
    systemDetailsData:any|undefined;                // System info that doesn't get charted but gets displayed
    ...
    constructor(player_in:DiceStatsPlayer){
        ...
        this.systemChartData = player_in._systemInfo.getSystemChartDisplayData();
        this.systemDetailsData = player_in._systemInfo.getDetailsDisplayData();
    }
