...
- ENABLE_AUTO_SAVE_DB ------ Players will save data to db whenever they roll ------[Def: false]   (Global)
- ENABLE_AUTO_LOAD_DB ------ Players will load data from db on joining the game-----[Def: false]   (Global)
