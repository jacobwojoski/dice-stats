export class PACKAGE_HIT_MISS_DATA {
     ...
     * @returns {HBS_HIT_MISS_DATA} - data onject that store the info we need to create the habndlebars template
     */
    static package_hit_miss_info(playerData) {
        //new HIT_MISS_HBS_DATA()
        
        // Create a hit miss obj dependent on the game system
